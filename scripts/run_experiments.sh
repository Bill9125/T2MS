...
python myinfer.py -d "$DATASET" --cfg_scale $BEST_CFG --total_step $BEST_STEP --fixed_noise --run_time 1

echo ">> 正在計算 Fixed Noise C-FID 分數..."
python myevaluation.py -d "$DATASET" --cfg_scale $BEST_CFG --total_step $BEST_STEP --fixed_noise --run_time 1 --n_folds 5

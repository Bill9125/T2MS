...
def get_args():
    ...
    parser.add_argument('--checkpoint_path', type=str, default='./results/denoiser_results/checkpoints/flowmatching_DiT_benchpress/model_6000.pth', help='checkpoint path')

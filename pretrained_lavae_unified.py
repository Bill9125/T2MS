...
parser.add_argument('--dataset_path', type=str, default='BP_data_new_skeleton', help='dataset name')
...
if __name__ == '__main__':
    save_folder_name = 'dataset{}_epoch{}'.format(args.dataset_path, args.num_training_updates)
